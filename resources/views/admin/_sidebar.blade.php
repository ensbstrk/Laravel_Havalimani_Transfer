        ...
        <div class="menu">
            <ul class="list">
                ...
                <li>
                    ...
                    <a href="{{route('admin_rezervation')}}" class="menu-toggle">
                        <i class="material-icons">view_list</i>
                ...
                <li>
                    ...
                    <a href="{{route('admin_location')}}" class="menu-toggle">
                        <i class="material-icons">view_list</i>
                        <span>Locations</span>
                    </a>
                ...
                <li>
                    ...
                    <a href="{{route('admin_setting')}}" class="menu-toggle">
                        <i class="material-icons">view_list</i>
                        <span>Settings</span>
                    </a>
                ...
                <li>
                    ...
                    <a href="{{route('admin_users')}}" class="menu-toggle">
                        <i class="material-icons">view_list</i>
                        <span>User</span>
                    </a>

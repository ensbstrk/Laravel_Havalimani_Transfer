    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h2>Transfer</h2>
                <a class="btn btn-primary m-t-15 waves-effect" href="{{route('admin_transfer_add')}}">Add Transfer</a>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($datalist as $rs)
                                    <tr>
                                        ...
                                        <td><a href="{{route('admin_transfer_delete',['id'=>$rs->id])}}"onclick="return confirm('Delete Emin Misin?')" >Delete</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>

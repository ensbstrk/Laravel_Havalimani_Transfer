...
@section('title','Havalimani Transfer')
@section('description')
    En güvenilir transfer...
@endsection
@section('keyworlds','Araba,Havalimani,Transfer')
        ...
        <div class="inner">
            ...
            <section class="tiles">
                <article class="style1">
									<span class="image">
										<img src="{{asset('assets/')}}/images/other-1-720x480.jpg" alt="" />
									</span>
                    <a href="offers.html">
                ...
                <article class="style2">
									<span class="image">
										<img src="{{asset('assets/')}}/images/other-2-720x480.jpg" alt="" />
									</span>
                    <a href="offers.html">
                        <h2>Lorem ipsum dolor sit amet, consectetur</h2>
                ...
                <article class="style3">
									<span class="image">
										<img src="{{asset('assets/')}}/images/other-3-720x480.jpg" alt="" />
									</span>
                    <a href="offers.html">
                        <h2>Lorem ipsum dolor sit amet, consectetur</h2>
